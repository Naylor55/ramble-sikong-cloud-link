package com.ramble.sikongcloudlink.handler.response;
 ...
 * Description 处理全局统一的响应，将 controller 的返回值封装成如下格式：
 * {
 *     "code": "000000",
 *     "data": "#Generated by Git-Commit-Id-Plugingit.branch=poc-v1.1.3-chongqinggit.build.time=2024-12-05T17\\:04\\:49+0800git.build.version=0.0.1-SNAPSHOTgit.commit.id.abbrev=afb4286git.commit.id.full=afb428637faaf9045cbfde9f14274da9d7ce4f0agit.commit.user.email=cnaylor@163.comgit.commit.user.name=\\u9648",
