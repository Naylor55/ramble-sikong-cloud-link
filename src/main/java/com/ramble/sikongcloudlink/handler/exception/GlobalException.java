package com.ramble.sikongcloudlink.handler.exception;


import com.ramble.sikongcloudlink.handler.GlobalResponseEntity;
 ...
 * Description 全局统一异常捕获器
 * @date 2023/7/7 9:37
 */


@RestControllerAdvice("com.ramble")
@ResponseBody
@Slf4j
public class GlobalException {
    ...
    public ResponseEntity<Object> handleBizServiceException(BizServiceException e) {
        log.error("捕获业务异常，捕获自定义异常,msg={}", e.getMessage());
        e.printStackTrace();
    ...
    public ResponseEntity<Object> handleRuntimeException(RuntimeException e) {
        ...
        return new ResponseEntity<>(
                new GlobalResponseEntity(false, "500001",
    ...
    public ResponseEntity<Object> handleException(Exception e) {
        return new ResponseEntity<>(
                new GlobalResponseEntity<>(false, "500000",
